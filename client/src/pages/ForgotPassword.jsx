    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2">We'll help you get back in</p>
        </div>
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl shadow-black/40">
          ...
          {message && (
            <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 px-4 py-2.5 rounded-lg mb-5 text-sm">
              {message}
            </div>
          )}
          {devResetUrl && (
            <div className="bg-amber-500/10 border border-amber-500/30 text-amber-200 px-4 py-3 rounded-lg mb-5 text-xs break-all">
              <p className="font-semibold mb-1">Demo mode — no email service configured:</p>
              <a href={devResetUrl} className="underline">{devResetUrl}</a>
            </div>
          )}
